...
export const LEVEL_1: LevelDef = {
  ...
  startLives: 20,
  waves: [
    { spawns: [{ enemyId: 'mouse', count: 6, interval: 0.9 }] },
    { spawns: [{ enemyId: 'mouse', count: 10, interval: 0.7 }] },
    {
      spawns: [
    ...
    { spawns: [{ enemyId: 'rat', count: 5, interval: 1.2 }] },
    {
      spawns: [
    ...
    { spawns: [{ enemyId: 'roomba', count: 3, interval: 2.0 }] },
    {
      spawns: [
